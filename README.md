...
Open any notebook above to preview its saved tables and figures on GitHub.
Run it in JupyterLab or a compatible editor for interactive charts; each notebook
includes the same viewing guide and static PNG fallbacks.
